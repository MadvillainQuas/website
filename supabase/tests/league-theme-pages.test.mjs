...
eq('fixtures, statistics, WOWY, news, a game and joining are league pages',
   ['/epinoia/fixtures/', '/epinoia/stats/', '/epinoia/stats/wowy/', '/epinoia/news/', '/epinoia/game/', '/epinoia/join/'].map(paints),
...
['fixtures/index.html', 'stats/index.html', 'stats/wowy/index.html', 'news/index.html', 'game/index.html', 'join/index.html']
...
console.log('\n-- each page\'s heading');
{
  ...
  ['fixtures/index.html', 'stats/wowy/index.html', 'news/index.html', 'join/index.html']
