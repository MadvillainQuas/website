/* GENERATED from epinoia/stars.js by supabase/tests/extract-shared.mjs — do not edit. */
'use strict';
/* ============================================================================
...
/* ---------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------- */
const __api = globalThis.EpinoiaStars;
export const { WINDOWS, PLAYER_KEYS, TEAM_KEYS, PLAYER_SEL, TEAM_SEL, unpick, computeWindow, pick, span, boxScores, global } = __api;
