/* GENERATED from epinoia/possessions.js by supabase/tests/extract-shared.mjs — do not edit. */
'use strict';
/* ============================================================================
...
/* ---------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------- */
const __api = globalThis.EpinoiaPossessions;
export const { enumerate, withVideo, summarise, OUTCOME, cumEl, LEAD_IN_MS, TAIL_MS } = __api;
