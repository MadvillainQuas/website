/* GENERATED from epinoia/gamepct.js by supabase/tests/extract-shared.mjs — do not edit. */
'use strict';
/* ============================================================================
...
/* ---------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------- */
const __api = globalThis.EpinoiaGamePct;
export const { rate, sample, adjusted, percentileOf, leagueKey, band, ord, cls, words, against } = __api;
