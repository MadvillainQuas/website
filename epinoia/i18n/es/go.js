...
(function () {
  ...
  I.register('es', {
    phrases: {
      ...
      'How far ahead': 'Plazo',
      'Nearest first, with the distance, the day and the time.': 'Del más cercano al más lejano, con la distancia, el día y la hora.',
      '24 hours': '24 horas',
      '3 days': '3 días',
      '7 days': '7 días',
      '2 weeks': '2 semanas',
      '30 days': '30 días',
      'Arena map': 'Mapa del pabellón',
      'back to my location': 'volver a mi ubicación',
      'change': 'cambiar',
      'Find a game': 'Buscar un partido',
      'Finding the games…': 'Buscando partidos…',
      'Further games': 'Partidos más lejanos',
      'Nearer games': 'Partidos más cercanos',
      'Games in this window': 'Partidos en este plazo',
      'Games near you': 'Partidos cerca de ti',
      'Go to a city, a country or an arena': 'Ve a una ciudad, un país o un pabellón',
      'Last five': 'Últimos cinco',
      'local time': 'hora local',
      'No arena or city by that name.': 'No hay ningún pabellón ni ciudad con ese nombre.',
      'No games with a known arena in this window. Try looking further ahead.': 'No hay partidos con pabellón conocido en este plazo. Prueba con un plazo más largo.',
      'Not shown: the arena’s pin is being checked': 'No se muestran: se está comprobando la ubicación del pabellón',
      'Passport mode': 'Modo pasaporte',
      'Pick a place above and its nearest games appear here.': 'Elige un lugar arriba y aquí aparecerán sus partidos más cercanos.',
      'pick where you are headed below.': 'elige abajo adónde vas.',
      'Places': 'Lugares',
      'Press “Use my location”, or go on passport mode, and the nearest games appear here.': 'Pulsa «Usar mi ubicación» o activa el modo pasaporte y aquí aparecerán los partidos más cercanos.',
      'Press the button and the nearest games appear.': 'Pulsa el botón y aparecerán los partidos más cercanos.',
      'Shown, nearest first': 'Mostrados, del más cercano',
      'The games could not be read just now.': 'No se han podido leer los partidos ahora mismo.',
      'The games nearest your passport place: the distance, the day and the time.': 'Los partidos más cercanos a tu lugar de pasaporte: la distancia, el día y la hora.',
      'time to be confirmed': 'hora por confirmar',
      'Using': 'Usando',
      'Where are you?': '¿Dónde estás?',
      'you are here': 'estás aquí',
      'your location': 'tu ubicación',
      'Your phone says where you are and the games are measured on it: your location is not sent anywhere. Or go on passport mode and stand somewhere else.': 'Tu teléfono dice dónde estás y los partidos se miden en él: tu ubicación no se envía a ningún sitio. O activa el modo pasaporte y colócate en otro lugar.',
